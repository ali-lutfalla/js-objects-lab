...
// I commented the commands for the sake of seeing and checking my answers I mean excersise 1 and 2 
...
// They all are ashe pokemans and I added them to the party property in the previous steps to evolve them all ^_^

game.party.splice(0,1,pokemon[1]);
game.party.splice(1,1,pokemon[4]);
game.party.splice(2,1,pokemon[7]);
game.party.splice(3,1,pokemon[26]);
